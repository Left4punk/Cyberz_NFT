...
def Get_Rarities ():
    ...
    Background_Rarity = [10,10,10,10,10,10,10]
    Base_Rarity = [10,10,10,10]
    Eyes_Rarity = [10,10,10,10,10,0,10]
...
def get_NFT_body (Image_Background, Image_Base, Image_Eyes):
    ...
    final_body = Image.alpha_composite(int0, Eyes_Image)

    return final_body
    

def get_NFT_and_Hair (Image_Background, Image_Base, Image_Eyes, Image_Hair, Image_Eyebrows):
    ...
    final_body = Image.alpha_composite(int2, Eyebrows_Image)

    return final_body
    
def get_NFT_and_Eyebrows (Image_Background, Image_Base, Image_Eyes, Image_Eyebrows):
    ...
    final_body = Image.alpha_composite(int1, Eyebrows_Image)

    return final_body

def get_full_nft (full_body, Image_Clothing, Image_Eyewear, Image_Mouth, Image_Headwear, Image_Mask):

    Clothes_Image = Image.open(Image_Clothing).convert("RGBA")

    int1 = Image.alpha_composite(full_body, Clothes_Image)

    Headwear_Image = Image.open(Image_Headwear).convert("RGBA")
    
    int2 = Image.alpha_composite(int1, Headwear_Image)
    
    Eyewear_Image = Image.open(Image_Eyewear).convert("RGBA")

    int3 = Image.alpha_composite(int2,Eyewear_Image)
    ...
    final = Image.alpha_composite(int4, Mask_Image)

    return final
def get_full_nft_no_mouth_mask (full_body, Image_Clothing, Image_Headwear):
    ...
    final = Image.alpha_composite(int1,Headwear_Image)    

    return final

def get_full_nft_no_mask (full_body, Image_Clothing, Image_Eyewear, Image_Mouth, Image_Headwear):
    ...
    final = Image.alpha_composite(int3, Mouth_Image)

    return final

def get_full_nft_no_eyewear (full_body, Image_Clothing, Image_Mouth, Image_Headwear, Image_Mask):
    ...
    final = Image.alpha_composite(int3, Mask_Image)
...
if __name__ == '__main__':
    ...
    while (i<collection_number):
        ...
        #print (NFT_Backgrounds, NFT_Base, NFT_Eyes, NFT_Eyewear, NFT_Headwear, NFT_Mask, NFT_Mouth, NFT_Clothing)
        ##image generation
        
        if (Need_Hair and NFT_Headwear not in ['1.png','3.png']):

            full_body = get_NFT_and_Hair (Image_Background, Image_Base, Image_Eyes, Image_Hair, Image_Eyebrows)
        
        elif (Need_Hair and NFT_Headwear in ['1.png','3.png']):
            
            full_body = get_NFT_and_Eyebrows (Image_Background, Image_Base, Image_Eyes, Image_Eyebrows)

        else:

            full_body = get_NFT_body (Image_Background, Image_Base, Image_Eyes)

        


        no_mask = False
        if (NFT_Headwear in ['2.png','4.png']):
            
            final = get_full_nft_no_mouth_mask (full_body, Image_Clothing, Image_Headwear)

        elif (NFT_Mouth in ['3.png','4.png','6.png']):
        
            no_mask = True
        
            final = get_full_nft_no_mask (full_body, Image_Clothing, Image_Eyewear, Image_Mouth, Image_Headwear)

        elif (NFT_Mask in ['1.png','2.png','3.png','4.png','5.png','6.png','7.png'] and no_mask == False):

            final = get_full_nft_no_eyewear (full_body, Image_Clothing, Image_Mouth, Image_Headwear, Image_Mask)


        else:
            final = get_full_nft (full_body, Image_Clothing, Image_Eyewear, Image_Mouth, Image_Headwear, Image_Mask)
